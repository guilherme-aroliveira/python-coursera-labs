...
def no_content():
    """
    Return a tuple with JSON message
    """
    return {"message": "hello horld"}, 204
...
def get_data():
    """
    Check if the variable 'data' exist
    """
    try:
...
def delete_by_uuid(id):
    """
    Delete the person from the data list with that id
    """
    for person in data:
        if person["id"] == str(id):
            data.remove(person)
...
def add_by_uuid():
    ...
    # code to validae new_person ommited
